...
# Start FTP Image Server
echo "2️⃣ Starting FTP Image Server..."
FTP_SERVER_FILE="$FRONTEND_DIR/ftp-image-server.js"
if [ -f "$FTP_SERVER_FILE" ]; then
    start_service "FTP Image Server" "$FRONTEND_DIR" "node ftp-image-server.js" 3003
else
    echo "❌ FTP Image Server not found: $FTP_SERVER_FILE"
fi
...
echo "   • FTP Image Server: http://localhost:3003"
echo ""
